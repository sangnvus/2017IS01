...
CREATE TABLE `districtname` (
  ...
  CONSTRAINT `FK_dpteta6m5d5q04gxsmc2sqxso` FOREIGN KEY (`LanguageCode`) REFERENCES `language` (`LanguageCode`),
  CONSTRAINT `FK_mwue94cyc9of3k140s4f6o085` FOREIGN KEY (`DistrictID`) REFERENCES `district` (`DistrictID`)
