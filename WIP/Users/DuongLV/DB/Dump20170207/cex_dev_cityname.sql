...
CREATE TABLE `cityname` (
  ...
  CONSTRAINT `FK_7x9ewa0xtheoa7vfrtcj6qbg2` FOREIGN KEY (`LanguageCode`) REFERENCES `language` (`LanguageCode`),
  CONSTRAINT `FK_ec6tdy2c4u37dtsagyf2dnlo` FOREIGN KEY (`CityID`) REFERENCES `city` (`CityID`)
