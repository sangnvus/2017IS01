  ...
  Circles.prototype = {
    ...
    htmlifyNumber: function(number, integerPartClass, decimalPartClass) {
      ...
      var parts = (number + '').split('.'),
          html  = '<span class="' + integerPartClass + '" style="color:#45AEEA">' + parts[0]+'</span>';

      if (parts.length > 1) {
              html += '<span class="' + integerPartClass + '" style="color:#45AEEA">' + "." + '</span>' + '<span class="' + decimalPartClass + '" style="color:#45AEEA">' + parts[1].substring(0, 2) + '</span>';
          }
      	 html += '<span class="' + decimalPartClass + '" style="color:#45AEEA">' + "%" + '</span>';
      return html;
    },
